...
- `features/drive-sync` concentra OAuth, cliente HTTP, busca por arquivos, normalização, conflitos e estados da interface. Não acesse o Drive diretamente em componentes fora dessa fatia.
