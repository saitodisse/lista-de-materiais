  ...
  return (
    ...
    >
      ...
      <LegalSection title="3. Google Drive opcional">
        ...
        <p>O aplicativo consulta o identificador opaco da conta e o endereço de e-mail da conta Google conectada para identificá-la em Configurações. Quando você autoriza a conexão em um Perfil local, esses dados, a confirmação do e-mail e as datas de conexão ficam guardados somente no IndexedDB deste aparelho para que o aplicativo tente restaurar a sessão silenciosamente quando você voltar à tela.</p>
        <p>O aplicativo não grava cookies do Google, tokens de acesso, a chave secreta do cliente ou credenciais. Cookies do Google permanecem sob o controle do navegador e podem não estar disponíveis quando você usa outro navegador, limpa os dados ou bloqueia a sessão Google.</p>
